        ...
        <div className="w-full 2xl:max-w-3xl flex flex-col items-center justify-center gap-y-10 2xl:-mt-20">
          <span
            className={clsx(
              ...
              theme ? "border-gray-700 text-gray-400" : "border-gray-300 text-gray-600"
            )}
          >
          ...
          >
            Welcome to joint our community
          </span>
          <div className="flex gap-6 items-center mt-6">
            <Button
              onClick={open}
              className={`${theme ? "bg-blue-600" : "bg-black"} text-white rounded h-10 text-sm`}
            >
              Get Started
            </Button>
